...
@section('content')
<button>
    <a href="/skills" class="bg-gray-400 hover:bg-gray-500 p-2 rounded-lg">back</a>
</button>
<div class="bg-white shadow-md rounded px-8 mt-12 pt-6 pb-8 mb-4 flex flex-col my-2">
    <div class="mb-6">
        <h1 class="text-2xl">Edit skills.</h1>
    </div>
    <form method="POST" action="{{ route('skills.update', $skills->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
